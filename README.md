...
| **背调** | 给选题配背景材料 | 双模式：技术板块=概念解释，人文板块=背景故事；可查阅 30 天往期做连续报道衔接；**薄材料新闻联网调查**——只有标题的新闻选题由背调联网搜索补充事实细节（带来源、经审核、撰写时按"据 X 报道"归因），论文选题不放宽 |
...
- **防幻觉的双材料制**——writer 被禁止使用自身知识：报道事实只能来自供稿材料，领域背景只能来自"背调 agent 产出 + 核查 agent 审校"的背景块。两条供给线各有独立纪律，写手专心写作。唯一受控例外是**新闻调查补充**：仅标题级的新闻/repo 选题由背调联网检索补事实（红线=只写检索结果、禁凭记忆），审核按新闻口径过一遍，成稿以"据 X 报道"归因——付费墙大刊的标题层和 X 上的只言片语因此变成可用信源。
