...
4. **材料深度决定篇幅，但薄材料的处置分两类**：每条标注了内容深度——「全文」可支撑 1200~2000 字；「摘要」支撑 800~1200 字。「仅标题」时：**论文**类材料薄就是薄，重要性再高也宁可放 brief；**新闻与开源项目（repo）类不受"仅标题"压制**——选题后有调查编辑联网检索补充事实材料（管线也会尝试补抓原文），按事件/项目本身的分量正常立题、定头条，target_length 从 800~1200 起步。你的职责是判断"值不值得报"，不是"现在手里材料够不够写"。
