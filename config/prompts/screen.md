...
参考来源信号（hf_upvotes=HF社区热度, hn_points=HN分数, stars_today=GitHub当日星标, hf_likes=模型点赞, oa_hindex=作者最高h指数, oa_inst=第一作者机构, oa_paper_cites=论文被引数, venue=顶级期刊来源——期刊收录本身是强质量信号）。信号是加分参考：高信号提示重要性，但无信号不等于不重要（全新论文常无信号）。
